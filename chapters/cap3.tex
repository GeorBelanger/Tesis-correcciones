...
La elección de la función de costo está altamente relacionada con la elección de la unidad de salida. La mayoría de las veces, simplemente se usa la entropía cruzada entre la distribución de los datos y la distribución del modelo. Por lo tanto, la elección de las unidades de salida determinan la forma que tendrá la función de la entropía cruzada. 
\cite{goodfellow-et-al-2016}
...
La red neuronal recurrente en la figura $3.2$ incorpora información de los datos de entrada $x$ al estado $h$ a través del tiempo. El cuadrado negro en las gráficas indicará el retraso en un paso de tiempo.
\cite{goodfellow-et-al-2016}
